  ...
  return(
    <section id="blog">
      ...
      <section className="blog-grid">
          ...
          <ScrollAnimation offset={50} animateOnce delay={100} animateIn="fadeInRight"><Link Link to="/Blog/Article/Modernize-Data-Management"><div><div className="data"></div><h3>Modernize Data Management</h3></div></Link></ScrollAnimation>
      </section>
    </section>
  )
}
